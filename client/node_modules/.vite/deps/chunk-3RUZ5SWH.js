...
function isFileInstance(data) {
  return _global.File && data instanceof File;
}
function isBufferInstance(data) {
  return _global.Buffer && data instanceof import_buffer.Buffer;
}
...
// node_modules/@thirdweb-dev/sdk/dist/transactions-e1717c1c.browser.esm.js
init_shim();

// node_modules/@thirdweb-dev/sdk/dist/index-1f21bb77.browser.esm.js
init_shim();
init_lib();
      ...
      switch (match[1].toLowerCase()) {
        ...
        case "https":
          ...
          const newProvider = chainId ? new StaticJsonRpcBatchProvider({
            url: rpcUrl,
            headers
          }, chainId) : new lib_exports2.JsonRpcBatchProvider({
            url: rpcUrl,
            headers
          });
...
async function fetchPublishedContractFromPolygon(publisherAddress, contractName) {
  ...
  const ContractPublisherAbi = (await import("./ContractPublisher-EFU3LJ45.js")).default;
...
async function getPrebuiltInfo(address, provider2) {
  try {
    const IThirdwebContractABI = (await import("./IThirdwebContract-LENTOLPI.js")).default;
...
async function resolveImplementation(address, provider2) {
  const bytecode2 = await fetchBytecode(address, provider2);
  ...
  for (const implementationAddress of impl) {
    if (implementationAddress && utils_exports.isAddress(implementationAddress) && implementationAddress !== lib_exports.AddressZero) {
      return {
        ...
        bytecode: await fetchBytecode(implementationAddress, provider2)
      };
    }
  }
  return {
...
async function getMetadataUriFromMultichainRegistry(address, chainId, sdkOptions) {
  var _a;
  const TWRegistryABI = (await import("./TWMultichainRegistryLogic-GZEWGIAK.js")).default;
...
Expected function signature: ${functions[0].signature}`);
  ...
  async defenderSendFunction(transaction) {
    ...
    const ForwarderABI = (await import("./Forwarder-EYRCB6B4.js")).default;
...
var EditionDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(address, provider2, storage), import("./edition-drop-e9eb17ee.browser.esm-2TVVJRR7.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC1155-ICNHLNWF.js")).default : (await import("./DropERC1155_V2-KD2Y7VCH.js")).default;
  }
};
var EditionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(address, provider2, storage), import("./edition-28de45af.browser.esm-WDYJI54L.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC1155-3HGOFPYN.js")).default;
  }
};
var MarketplaceInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(address, provider2, storage), import("./marketplace-df611ee5.browser.esm-ZDPWOR6E.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Marketplace-ZNLTAVED.js")).default;
  }
};
var MarketplaceV3Initializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceV3Initializer.getAbi(address, provider2, storage, options), import("./marketplacev3-81da8ea6.browser.esm-NTLNYOYX.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage, options) => {
    ...
    const localAbi = (await import("./MarketplaceV3-33UHD2IM.js")).default;
...
var MultiwrapInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(address, provider2, storage), import("./multiwrap-ab66c6ca.browser.esm-EMPD3M2P.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Multiwrap-U43RZDCO.js")).default;
  }
};
var NFTCollectionInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(address, provider2, storage), import("./nft-collection-bad4f5c7.browser.esm-W5LIX5F7.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC721-3M2YGKEY.js")).default;
  }
};
var NFTDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(address, provider2, storage), import("./nft-drop-6589db8e.browser.esm-FPB52FUI.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 3 ? (await import("./DropERC721-B6AOVXFT.js")).default : (await import("./DropERC721_V3-7ORA6PEV.js")).default;
  }
};
var PackInitializer = {
  name: "Pack",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(address, provider2, storage), import("./pack-da7fbe6f.browser.esm-I36FGHZ7.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return AbiSchema.parse((await import("./Pack-FUMTBDLR.js")).default || []);
  }
};
var SignatureDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(address, provider2, storage), import("./signature-drop-7264804b.browser.esm-TYLLYSUF.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 4 ? (await import("./SignatureDrop-YWGJTGI7.js")).default : (await import("./SignatureDrop_V4-NLWAB6W5.js")).default;
  }
};
var SplitInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(address, provider2, storage), import("./split-daca33d0.browser.esm-WUBIEID5.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./Split-UV5IQV6P.js")).default;
  }
};
var TokenDropInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(address, provider2, storage), import("./token-drop-8d966615.browser.esm-NSYRRI7I.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    const contractInfo = await getContractInfo(address, provider2);
    return !contractInfo || contractInfo.version > 2 ? (await import("./DropERC20-I23PXPLA.js")).default : (await import("./DropERC20_V2-QFYIR56D.js")).default;
  }
};
var TokenInitializer = {
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(address, provider2, storage), import("./token-317867a4.browser.esm-3KAZEWK2.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./TokenERC20-NLMCZ6UA.js")).default;
  }
};
var VoteInitializer = {
  name: "VoteERC20",
  ...
  initialize: async function() {
    ...
    const [, provider2] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(address, provider2, storage), import("./vote-3822f284.browser.esm-W7UAHUBU.js"), provider2.getNetwork()]);
  ...
  getAbi: async (address, provider2, storage) => {
    ...
    return (await import("./VoteERC20-CYRNKLMO.js")).default;
  }
};
...
async function engineSendFunction(transaction, signer, provider2, storage, gaslessOptions) {
  ...
  const request = await enginePrepareRequest(transaction, signer, provider2, storage);
...
async function enginePrepareRequest(transaction, signer, provider2, storage) {
  const forwarderAddress = CONTRACT_ADDRESSES[transaction.chainId].openzeppelinForwarder || await computeForwarderAddress(provider2, storage);
  const ForwarderABI = (await import("./Forwarder-EYRCB6B4.js")).default;
  const forwarder = new Contract(forwarderAddress, ForwarderABI, provider2);
  const nonce = await getAndIncrementNonce(forwarder, "getNonce", [transaction.from]);
  const domain = {
...
//# sourceMappingURL=chunk-3RUZ5SWH.js.map
