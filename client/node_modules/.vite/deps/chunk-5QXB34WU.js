...
} from "./chunk-KXRTQPGJ.js";
import {
  getAllInBatches,
  handleTokenApproval,
  isTokenApprovedForTransfer
} from "./chunk-6TRV3EHZ.js";
import {
  ContractInterceptor
...
// node_modules/@thirdweb-dev/sdk/dist/marketplacev3-offers-09107391.browser.esm.js
init_shim();
init_lib();
...
var MarketplaceV3DirectListings = class {
  ...
  async isStillValidListing(listing, quantity) {
    ...
    const ERC165Abi = (await import("./IERC165-4BFQWQLK.js")).default;
    const erc165 = new Contract(listing.assetContractAddress, ERC165Abi, provider);
    const isERC721 = await erc165.supportsInterface(InterfaceId_IERC721);
    const isERC1155 = await erc165.supportsInterface(InterfaceId_IERC1155);
    if (isERC721) {
      const ERC721Abi = (await import("./IERC721-V4QM7AXP.js")).default;
      ...
      const ERC1155Abi = (await import("./IERC1155-RIFEAKV4.js")).default;
...
//# sourceMappingURL=chunk-5QXB34WU.js.map
