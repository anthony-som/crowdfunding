...
// node_modules/@thirdweb-dev/sdk/dist/sdk-8f192b27.browser.esm.js
init_shim();
...
var UserWallet = class {
  ...
  async transfer(to, amount) {
    ...
    if (isNativeToken(resolvedCurrency)) {
      ...
      const ERC20Abi = (await import("./IERC20-KLBA4SC6.js")).default;
      return {
...
var ThirdwebSDK = class extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import("./smart-contract-1e6b441e.browser.esm-3GQ4VFP5.js")]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
...
var ContractDeployer = class extends RPCConnectionHandler {
  constructor(network, options, storage) {
    ...
    __publicField(this, "deployProxy", buildDeployTransactionFunction(async (implementationAddress, implementationAbi, initializerFunction, initializerArgs) => {
      ...
      const {
        TWProxy__factory
      } = await import("./thirdweb-dev-contracts-js-factories-TWProxy__factory.browser.esm-OIV3QQQE.js");
...
${bytecode}`);
  ...
  async getRegistry() {
    ...
    return this._registry = this.getProvider().getNetwork().then(async (_ref2) => {
      ...
      const TWRegistryABI = (await import("./TWRegistry-RZIZMPZT.js")).default;
...
// node_modules/@thirdweb-dev/sdk/dist/token-bde6b0dd.browser.esm.js
init_shim();
init_lib();
...
// node_modules/@thirdweb-dev/sdk/dist/watchTransactions-b2ed2434.browser.esm.js
init_shim();
init_lib();
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import("./smart-contract-1e6b441e.browser.esm-3GQ4VFP5.js")]);
...
async function getContract(params) {
  ...
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import("./contract-publisher-b459619e.browser.esm-4OIUARMQ.js").then(function(n) {
    return n.c;
  })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
...
//# sourceMappingURL=chunk-SRFLFQ4O.js.map
