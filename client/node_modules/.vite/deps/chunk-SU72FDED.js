...
var require_sha256 = __commonJS({
  "node_modules/@stablelib/sha256/lib/sha256.js"(exports) {
    ...
    function hashBlocks(w3, v2, p3, pos, len) {
      while (len >= 64) {
        var a2 = v2[0];
        var b2 = v2[1];
        var c3 = v2[2];
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e >>> 6 | e << 32 - 6) ^ (e >>> 11 | e << 32 - 11) ^ (e >>> 25 | e << 32 - 25)) + (e & f2 ^ ~e & g3) | 0) + (h4 + (K3[i2] + w3[i2] | 0) | 0) | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n2, p3) {
      ...
      const a2 = gf(), b2 = gf(), c3 = gf(), d2 = gf(), e = gf(), f2 = gf();
          ...
          if (g3[n2])
            i2[n2] = function(v2) {
              return new Promise(function(a2, b2) {
                q3.push([n2, v2, a2, b2]) > 1 || resume(n2, v2);
              });
            };
        }
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p3, q3) {
      const a2 = gf(), b2 = gf(), c3 = gf(), d2 = gf(), e = gf(), f2 = gf(), g3 = gf(), h4 = gf(), t = gf();
      sub(a2, p3[1], p3[0]);
      sub(t, q3[1], q3[0]);
      mul(a2, a2, t);
      add(b2, p3[0], p3[1]);
    ...
    function modL(r, x3) {
      ...
      for (i2 = 63; i2 >= 32; --i2) {
        ...
        for (j3 = i2 - 32, k3 = i2 - 12; j3 < k3; ++j3) {
          x3[j3] += carry - 16 * x3[i2] * L2[j3 - (i2 - 32)];
...
function ee(e) {
  ...
  if ($(t) === _) {
    const l2 = r + X, d2 = l2 + Z, c3 = n2.slice(r, l2), u2 = n2.slice(l2, d2), a2 = n2.slice(d2);
    return { type: t, sealed: a2, iv: u2, senderPublicKey: c3 };
  }
...
function ke() {
  if (R() === m.reactNative && typeof _global < "u" && typeof (_global == null ? void 0 : _global.Platform) < "u") {
...
function Jn({ protocol: e, version: n2, relayUrl: t, sdkVersion: r, auth: o, projectId: s, useOnCloseEvent: i2 }) {
  const l2 = t.split("?"), d2 = Me(e, n2, r), c3 = { auth: o, ua: d2, projectId: s, useOnCloseEvent: i2 || void 0 }, u2 = De(l2[1] || "", c3);
  return l2[0] + "?" + u2;
}
function O(e, n2) {
...
function $t(e, n2) {
  ...
  return O(o, r) ? (r.forEach((i2) => {
    const { accounts: l2, methods: d2, events: c3 } = e.namespaces[i2], u2 = A(l2), a2 = t[i2];
    (!O(K(i2, a2), u2) || !O(a2.methods, d2) || !O(a2.events, c3)) && (s = false);
  }), s) : false;
}
function k(e) {
...
function ie(e) {
  let n2 = true;
  return D(e) ? e.length && (n2 = e.every((t) => h(t, false))) : n2 = false, n2;
}
function nn(e, n2, t) {
  let r = null;
  return D(n2) && n2.length ? n2.forEach((o) => {
...
function Kt(e, n2) {
  let t = false;
  return n2 && !e ? t = true : e && D(e) && e.length && e.forEach((r) => {
    t = an(r);
  }), t;
}
function Lt(e) {
...
function un(e, n2, t) {
  let r = null;
  const o = Yt(e), s = Jt(n2), i2 = Object.keys(o), l2 = Object.keys(s), d2 = ln(Object.keys(e)), c3 = ln(Object.keys(n2)), u2 = d2.filter((a2) => !c3.includes(a2));
  return u2.length && (r = N("NON_CONFORMING_NAMESPACES", `${t} namespaces keys don't satisfy requiredNamespaces.
      Required: ${u2.toString()}
      Received: ${Object.keys(n2).toString()}`)), O(i2, l2) || (r = N("NON_CONFORMING_NAMESPACES", `${t} namespaces chains don't satisfy required namespaces.
      Required: ${i2.toString()}
      Approved: ${l2.toString()}`)), Object.keys(n2).forEach((a2) => {
    if (!a2.includes(":") || r)
      return;
    const b2 = A(n2[a2].accounts);
    b2.includes(a2) || (r = N("NON_CONFORMING_NAMESPACES", `${t} namespaces accounts don't satisfy namespace accounts for ${a2}
        Required: ${a2}
...
async function fn() {
  if (j() && typeof _global < "u" && _global != null && _global.NetInfo) {
...
function yn(e) {
  var _a;
  j() && typeof _global < "u" && _global != null && _global.NetInfo && ((_a = _global) == null ? void 0 : _a.NetInfo.addEventListener((n2) => e(n2 == null ? void 0 : n2.isConnected)));
}
var ae = {};
var er = class {
  static get(n2) {
...
var z = (i2 = {}) => {
  ...
  let n2;
  return i2.dbName && i2.storeName && (n2 = createStore(i2.dbName, i2.storeName)), { name: x2, options: i2, async hasItem(s) {
...
var resolveWebSocketImplementation = () => {
  if (typeof WebSocket !== "undefined") {
    return WebSocket;
  } else if (typeof _global !== "undefined" && typeof _global.WebSocket !== "undefined") {
...
var hasBuiltInWebSocket = () => typeof WebSocket !== "undefined" || typeof _global !== "undefined" && typeof _global.WebSocket !== "undefined" || typeof window !== "undefined" && typeof window.WebSocket !== "undefined" || typeof self !== "undefined" && typeof self.WebSocket !== "undefined";
...
function Bi(r, e) {
  ...
  var o = r.length, h4 = r.charAt(0), u2 = Math.log(o) / Math.log(256), d2 = Math.log(256) / Math.log(o);
  function p3(c3) {
    ...
    if (c3.length === 0)
      return "";
    for (var m2 = 0, z2 = 0, I = 0, _3 = c3.length; I !== _3 && c3[I] === 0; )
      I++, m2++;
    for (var S3 = (_3 - I) * d2 + 1 >>> 0, b2 = new Uint8Array(S3); I !== _3; ) {
      for (var T = c3[I], A2 = 0, C = S3 - 1; (T !== 0 || A2 < z2) && C !== -1; C--, A2++)
        T += 256 * b2[C] >>> 0, b2[C] = T % o >>> 0, T = T / o >>> 0;
      if (T !== 0)
        throw new Error("Non-zero carry");
      z2 = A2, I++;
    }
    for (var x3 = S3 - z2; x3 !== S3 && b2[x3] === 0; )
      x3++;
    for (var j3 = h4.repeat(m2); x3 < S3; ++x3)
      j3 += r.charAt(b2[x3]);
    return j3;
  }
  function y3(c3) {
    ...
    var m2 = 0;
    if (c3[m2] !== " ") {
      for (var z2 = 0, I = 0; c3[m2] === h4; )
        z2++, m2++;
      for (var _3 = (c3.length - m2) * u2 + 1 >>> 0, S3 = new Uint8Array(_3); c3[m2]; ) {
        var b2 = t[c3.charCodeAt(m2)];
        if (b2 === 255)
          return;
        for (var T = 0, A2 = _3 - 1; (b2 !== 0 || T < I) && A2 !== -1; A2--, T++)
          b2 += o * S3[A2] >>> 0, S3[A2] = b2 % 256 >>> 0, b2 = b2 / 256 >>> 0;
        if (b2 !== 0)
          throw new Error("Non-zero carry");
        I = T, m2++;
      }
      if (c3[m2] !== " ") {
        for (var C = _3 - I; C !== _3 && S3[C] === 0; )
          C++;
...
var Xi = (r, e, t, i2) => {
  ...
  for (let d2 = 0; d2 < n2; ++d2) {
    ...
    h4 = h4 << t | p3, o += t, o >= 8 && (o -= 8, a2[u2++] = 255 & h4 >> o);
  }
  if (o >= t || 255 & h4 << 8 - o)
...
var ns = B2({ prefix: "9", name: "base10", alphabet: "0123456789" });
...
var Es = B2({ prefix: "k", name: "base36", alphabet: "0123456789abcdefghijklmnopqrstuvwxyz" });
var ws = B2({ prefix: "K", name: "base36upper", alphabet: "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" });
var vs = Object.freeze({ __proto__: null, base36: Es, base36upper: ws });
var Is = B2({ name: "base58btc", prefix: "z", alphabet: "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz" });
var Cs = B2({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
...
var ce2 = (r, e) => {
  ...
  return ke2(r, n2, 0), ke2(t, n2, i2), n2.set(e, s), new er2(r, t, e, n2);
};
var er2 = class {
  constructor(e, t, i2, s) {
...
var Be2 = ({ name: r, code: e, encode: t }) => new tr(r, e, t);
var tr = class {
  constructor(e, t, i2) {
...
var ir = Be2({ name: "sha2-256", code: 18, encode: Ve2("SHA-256") });
var sr = Be2({ name: "sha2-512", code: 19, encode: Ve2("SHA-512") });
var rr = Object.freeze({ __proto__: null, sha256: ir, sha512: sr });
var qe2 = 0;
var nr = "identity";
var je2 = ze;
var ar = (r) => ce2(qe2, je2(r));
var or = { code: qe2, name: nr, encode: je2, digest: ar };
var hr = Object.freeze({ __proto__: null, identity: or });
...
var ur = { utf8: Je2, "utf-8": Je2, hex: Ye.base16, latin1: ue2, ascii: ue2, binary: ue2, ...Ye };
function lr(r, e = "utf8") {
  const t = ur[e];
  if (!t)
...
var St = class {
  constructor(e, t, i2) {
    this.core = e, this.logger = t, this.name = Ze2, this.initialized = false, this.init = async () => {
      ...
      this.isInitialized();
      const n2 = await this.getClientSeed(), a2 = generateKeyPair2(n2), o = Dn(), h4 = et2;
      ...
      if (Fn(o)) {
        const y3 = o.senderPublicKey, M2 = o.receiverPublicKey;
        s = await this.generateSharedKey(y3, M2);
      }
      const u2 = this.getSymKey(s), { type: d2, senderPublicKey: p3 } = o;
      return Kn({ type: d2, symKey: u2, message: h4, senderPublicKey: p3 });
    }, this.decode = async (s, n2, a2) => {
      this.isInitialized();
      const o = xn(n2, a2);
      if (Fn(o)) {
        const h4 = o.receiverPublicKey, u2 = o.senderPublicKey;
        s = await this.generateSharedKey(h4, u2);
      }
      try {
        const h4 = this.getSymKey(s), u2 = Ln({ symKey: h4, encoded: n2 });
    ...
    }, this.core = e, this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.keychain = i2 || new _t2(this.core, this.logger);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var yr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = at2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time3.toMiliseconds)(import_time3.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i2, s, n2) => {
      ...
      try {
        const o = (n2 == null ? void 0 : n2.ttl) || nt2, h4 = mt(n2), u2 = (n2 == null ? void 0 : n2.prompt) || false, d2 = (n2 == null ? void 0 : n2.tag) || 0, p3 = (n2 == null ? void 0 : n2.id) || getBigIntRpcId().toString(), y3 = { topic: i2, message: s, opts: { ttl: o, relay: h4, prompt: u2, tag: d2, id: p3 } }, M2 = setTimeout(() => this.queue.set(p3, y3), this.publishTimeout);
        try {
          await await it(this.rpcPublish(i2, s, o, h4, u2, d2, p3), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p3), this.relayer.events.emit(D3.publish, y3);
        } catch (c3) {
          if (this.logger.debug("Publishing Payload stalled"), this.needsTransportRestart = true, (a2 = n2 == null ? void 0 : n2.internal) != null && a2.throwOnFailedPublish)
            throw this.removeRequestFromQueue(p3), c3;
          return;
        } finally {
          clearTimeout(M2);
        }
  ...
  rpcPublish(e, t, i2, s, n2, a2, o) {
    ...
    return w((h4 = y3.params) == null ? void 0 : h4.prompt) && ((u2 = y3.params) == null || delete u2.prompt), w((d2 = y3.params) == null ? void 0 : d2.tag) && ((p3 = y3.params) == null || delete p3.tag), this.logger.debug("Outgoing Relay Payload"), this.logger.trace({ type: "message", direction: "outgoing", request: y3 }), this.relayer.request(y3);
  }
...
var xt2 = (r, e, t) => e in r ? br(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var q2 = (r, e) => {
  for (var t in e || (e = {}))
...
var De2 = (r, e) => fr(r, Er(e));
var Ot = class extends d {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.subscriptions = /* @__PURE__ */ new Map(), this.topicMap = new mr(), this.events = new import_events5.EventEmitter(), this.name = yt2, this.version = mt2, this.pending = /* @__PURE__ */ new Map(), this.cached = [], this.initialized = false, this.pendingSubscriptionWatchLabel = "pending_sub_watch_label", this.pollingInterval = 20, this.storagePrefix = O3, this.subscribeTimeout = 1e4, this.restartInProgress = false, this.batchSubscribeTopicsLimit = 500, this.init = async () => {
  ...
  addSubscription(e, t) {
    this.subscriptions.set(e, q2({}, t)), this.topicMap.set(t.topic, e), this.events.emit(w2.created, t);
  }
  getSubscription(e) {
  ...
  deleteSubscription(e, t) {
    ...
    this.subscriptions.delete(e), this.topicMap.delete(i2.topic, e), this.events.emit(w2.deleted, De2(q2({}, i2), { reason: t }));
  }
  async persist() {
...
var At2 = Object.getOwnPropertySymbols;
var Cr = Object.prototype.hasOwnProperty;
var Rr = Object.prototype.propertyIsEnumerable;
var zt2 = (r, e, t) => e in r ? Ir(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var _r = (r, e) => {
  for (var t in e || (e = {}))
    Cr.call(e, t) && zt2(r, t, e[t]);
  if (At2)
    for (var t of At2(e))
      Rr.call(e, t) && zt2(r, t, e[t]);
  return r;
};
var Nt2 = class extends g {
  ...
  async onProviderPayload(e) {
    if (this.logger.debug("Incoming Relay Payload"), this.logger.trace({ type: "payload", direction: "incoming", payload: e }), isJsonRpcRequest(e)) {
      ...
      this.logger.debug("Emitting Relayer Payload"), this.logger.trace(_r({ type: "event", event: t.id }, a2)), this.events.emit(t.id, a2), await this.acknowledgePayload(e), await this.onMessageEvent(a2);
    } else
...
var Lt2 = (r, e, t) => e in r ? Sr(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var Ft2 = (r, e) => {
  for (var t in e || (e = {}))
    Tr.call(e, t) && Lt2(r, t, e[t]);
  if (Ut)
    for (var t of Ut(e))
...
var $t2 = class extends p2 {
  constructor(e, t, i2, s = O3, n2 = void 0) {
    super(e, t, i2, s), this.core = e, this.logger = t, this.name = i2, this.map = /* @__PURE__ */ new Map(), this.version = pt2, this.cached = [], this.initialized = false, this.storagePrefix = O3, this.init = async () => {
      ...
      const h4 = Ft2(Ft2({}, this.getData(a2)), o);
...
var Mt2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = ft2, this.version = Et2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = O3, this.ignoredPayloadTypes = [_], this.registeredMethods = [], this.init = async () => {
      ...
      this.isInitialized();
      const i2 = Dn(), s = await this.core.crypto.setSymKey(i2), n2 = lt(import_time3.FIVE_MINUTES), a2 = { protocol: ot }, o = { topic: s, expiry: n2, relay: a2, active: false }, h4 = Nt({ protocol: this.core.protocol, version: this.core.version, topic: s, symKey: i2, relay: a2 });
      ...
      const h4 = lt(import_time3.FIVE_MINUTES), u2 = { topic: s, relay: a2, expiry: h4, active: false };
      return await this.pairings.set(s, u2), this.core.expirer.set(s, h4), i2.activatePairing && await this.activate({ topic: s }), this.events.emit(V2.create, u2), u2;
      ...
      const a2 = formatJsonRpcRequest(s, n2), o = await this.core.crypto.encode(i2, a2), h4 = F2[s].req;
      return this.core.history.set(i2, a2), this.core.relayer.publish(i2, o, h4), a2.id;
    }, this.sendResult = async (i2, s, n2) => {
      const a2 = formatJsonRpcResult(i2, n2), o = await this.core.crypto.encode(s, a2), h4 = await this.core.history.get(s, i2), u2 = F2[h4.request.method].res;
      await this.core.relayer.publish(s, o, u2), await this.core.history.resolve(a2);
    }, this.sendError = async (i2, s, n2) => {
      const a2 = formatJsonRpcError(i2, n2), o = await this.core.crypto.encode(s, a2), h4 = await this.core.history.get(s, i2), u2 = F2[h4.request.method] ? F2[h4.request.method].res : F2.unregistered_method.res;
      await this.core.relayer.publish(s, o, u2), await this.core.history.resolve(a2);
...
var kt2 = class extends h3 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = wt, this.version = vt2, this.cached = [], this.initialized = false, this.storagePrefix = O3, this.init = async () => {
...
var Kt2 = class extends E2 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = It, this.version = Ct2, this.cached = [], this.initialized = false, this.storagePrefix = O3, this.init = async () => {
  ...
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = Z2, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i2) => {
      ...
      try {
        ...
        this.logger.info(`failed to resolve attestation: ${i2.attestationId} from url: ${s}`), this.logger.info(a2), n2 = await this.fetchAttestation(i2.attestationId, ee2);
      }
      return n2;
      ...
      await Promise.race([new Promise((n2) => {
        ...
        a2.id = Z2, a2.src = `${this.verifyUrl}/${this.projectId}`, a2.style.display = "none", document.body.append(a2), this.iframe = a2, i2 = n2;
      ...
      let s = i2 || $2;
      return Rt.includes(s) || (this.logger.info(`verify url: ${s}, not included in trusted list, assigning default: ${$2}`), s = $2), s;
...
var qt2 = (r, e, t) => e in r ? xr(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
var jt2 = (r, e) => {
  for (var t in e || (e = {}))
    Or.call(e, t) && qt2(r, t, e[t]);
  if (Vt2)
    for (var t of Vt2(e))
      Ar.call(e, t) && qt2(r, t, e[t]);
  return r;
};
var te2 = class extends n {
  constructor(e) {
    super(e), this.protocol = le2, this.version = We2, this.name = Q2, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i2, s) => this.events.on(i2, s), this.once = (i2, s) => this.events.once(i2, s), this.off = (i2, s) => this.events.off(i2, s), this.removeListener = (i2, s) => this.events.removeListener(i2, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || ge, this.customStoragePrefix = e != null && e.customStoragePrefix ? `:${e.customStoragePrefix}` : "";
    ...
    this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new St(this, this.logger, e == null ? void 0 : e.keychain), this.history = new kt2(this, this.logger), this.expirer = new Kt2(this, this.logger), this.storage = e != null && e.storage ? e.storage : new h2(jt2(jt2({}, Qe2), e == null ? void 0 : e.storageOptions)), this.relayer = new Nt2({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Mt2(this, this.logger), this.verify = new Bt2(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new te2(e);
    await t.initialize();
...
***************************************************************************** */
//# sourceMappingURL=chunk-SU72FDED.js.map
