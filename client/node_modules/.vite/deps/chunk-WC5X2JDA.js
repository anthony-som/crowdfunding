...
// node_modules/@thirdweb-dev/sdk/dist/QueryParams-151a4a33.browser.esm.js
init_shim();
init_lib();
...
async function fetchTokenMetadataForContract(contractAddress, provider, tokenId, storage) {
  let uri;
  const ERC165MetadataAbi = (await import("./IERC165-4BFQWQLK.js")).default;
  ...
  if (isERC721) {
    const ERC721MetadataAbi = (await import("./IERC721Metadata-QMVPWTRR.js")).default;
    const erc721 = new Contract(contractAddress, ERC721MetadataAbi, provider);
    uri = await erc721.tokenURI(tokenId);
  } else if (isERC1155) {
    const ERC1155MetadataAbi = (await import("./IERC1155Metadata-O7NNUD4Q.js")).default;
...
//# sourceMappingURL=chunk-WC5X2JDA.js.map
