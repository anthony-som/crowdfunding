...
// node_modules/@thirdweb-dev/react/dist/paperWallet-45747917.browser.esm.js
init_shim();
var import_react16 = __toESM(require_react());

// node_modules/@thirdweb-dev/react/dist/useWalletConnect-33979a96.browser.esm.js
init_shim();
...
function OTPInput(props) {
  ...
  const boxEls = (0, import_react14.useRef)([]);
  (0, import_react14.useEffect)(() => {
...
`;
var BounceContainer = newStyled.div`
...
var EmbeddedWalletOTPLoginUI = (props) => {
  ...
  const [emailStatus, setEmailStatus] = (0, import_react14.useState)("sending");
...
function SendFunds(props) {
  ...
  const [receiverAddress, setReceiverAddress] = (0, import_react14.useState)("");
...
var WalletAddressContainer = newStyled.button`
  all: unset;
  width: 100%;
  box-sizing: border-box;
  cursor: pointer;
...
var ConnectedWalletDetails = (props) => {
  ...
  let networkSwitcherButton = (0, import_jsx_runtime.jsxs)(MenuButton, {
    type: "button",
  ...
  if (!disableSwitchChain) {
    networkSwitcherButton = (0, import_jsx_runtime.jsx)(ToolTip, {
  ...
  const content = (0, import_jsx_runtime.jsxs)("div", {
    children: [(0, import_jsx_runtime.jsxs)(Container, {
      ...
      flex: "column",
      gap: "sm",
      children: [personalWallet && personalWalletConfig && !props.hideSwitchToPersonalWallet && (0, import_jsx_runtime.jsx)(WalletSwitcher, {
...
var ThirdwebProvider = (_ref) => {
  ...
  const ewsRef = (0, import_react14.useRef)(false);
  (0, import_react14.useEffect)(() => {
    if (ewsRef.current) {
      return;
    }
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-RUQWWL37.js");
...
function useRainbowWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-ba658c19.browser.esm-HF4UE6V6.js").then(function(n) {
      return n.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react14.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-5086d529.browser.esm-UHSQEIUG.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-41e93ea8.browser.esm-L7PV352P.js");
...
function useEmbeddedWallet() {
  ...
  const connect = (0, import_react14.useCallback)(async (authParams) => {
  ...
  const sendVerificationEmail = (0, import_react14.useCallback)(async (_ref) => {
    let {
      email
    } = _ref;
...
var useEmbeddedWalletSendVerificationEmail = () => {
  const context = useWalletContext();
  const sendVerificationEmail = (0, import_react14.useCallback)(async (email) => {
    if (!context.clientId) {
...
function usePaperWallet() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-45747917.browser.esm-CXWIEDXT.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react14.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-1be17232.browser.esm-Q6X5J5TI.js");
...
var LinkButton2 = newStyled.button`
  all: unset;
  color: ${(p) => p.theme.colors.accentText};
  font-size: ${fontSize.sm};
  cursor: pointer;
...
//# sourceMappingURL=chunk-YP73WKUX.js.map
