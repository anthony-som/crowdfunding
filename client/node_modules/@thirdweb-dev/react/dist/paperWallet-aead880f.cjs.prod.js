...
require('./safeChainSlug-48e1c5bd.cjs.prod.js');
require('qrcode');
require('ethers');
...
const PaperFormUI = props => {
  ...
  const googleLogin = async () => {
    try {
      ...
      const googleWindow = useWalletConnect.openOauthSignInWindow("google", themeObj);
      if (!googleWindow) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(formElements.Container, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("form", {
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(useWalletConnect.OTPInput, {
