...
const TrustScan = _ref => {
  ...
  const locale = formElements.useTWLocale().wallets.trustWallet;
  const createInstance = reactCore.useCreateWalletInstance();
  const [qrCodeUri, setQrCodeUri] = React.useState();
  const {
    setConnectedWallet,
...
const ZerionScan = _ref => {
  ...
  const locale = formElements.useTWLocale().wallets.zerionWallet;
  const createInstance = reactCore.useCreateWalletInstance();
  const [qrCodeUri, setQrCodeUri] = React.useState();
  const {
    setConnectedWallet,
...
const RainbowScan = _ref => {
  ...
  const locale = formElements.useTWLocale().wallets.rainbowWallet;
  const createInstance = reactCore.useCreateWalletInstance();
  const [qrCodeUri, setQrCodeUri] = React.useState();
  const {
    setConnectedWallet,
