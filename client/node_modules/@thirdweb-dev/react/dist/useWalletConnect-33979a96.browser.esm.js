...
import { LockOpen1Icon, EyeClosedIcon, EyeOpenIcon, CheckIcon, PinBottomIcon, CopyIcon as CopyIcon$1, Cross2Icon, MagnifyingGlassIcon, CrossCircledIcon, CheckCircledIcon, ChevronRightIcon, PaperPlaneIcon, ShuffleIcon, TextAlignLeftIcon, EnterIcon, ExternalLinkIcon, ReloadIcon } from '@radix-ui/react-icons';
import { B as Button, s as spacing, f as fontSize, u as useTWLocale, C as Container, I as Img, n as TextDivider, M as ModalHeader, S as Spacer, a as iconSize, T as Text, c as Spinner, o as fadeInAnimation, p as Input, q as media, t as IconButton, L as Line, v as InputContainer, w as InputButton, W as WalletEntryButton, b as ModalDescription, e as Label, x as ScreenBottomContainer, r as radius, y as shadow, z as noScrollBar, A as lightThemeObj, D as darkThemeObj, E as ModalTitle, i as isMobile, F as Link, d as ModalConfigCtx, G as TOS, m as useSetIsWalletModalOpen, H as SetModalConfigCtx, k as useIsWalletModalOpen, J as WalletSelector, K as WalletUIStatesProvider, N as ThirdwebLocaleContext, j as en } from './formElements-fe6c6980.browser.esm.js';
import { g as googleIconUri, a as appleIconUri, I as InputSelectionUI, e as emailIcon, u as useScreenContext, r as reservedScreens, T as ToolTip, m as modalCloseFadeOutDuration, w as wideModalMaxHeight, b as modalMaxWidthCompact, c as modalMaxWidthWide, d as compactModalMaxHeight, s as smartWalletIcon, o as onModalUnmount, f as useScreen, S as ScreenContext, h as defaultTheme } from './Tooltip-c0af7e77.browser.esm.js';
import { useCreateWalletInstance, useSetConnectionStatus, useSetConnectedWallet, useConnectionStatus, useWalletContext, useWallet, useAddress, shortenAddress, useStorage, useSupportedChains, useSwitchChain, useChainId, useBalance, useChain, shortenString, useDisconnect, useWalletConfig, useENS, useSDK, useLogin, useWallets, useThirdwebAuthContext, useLogout, useNetworkMismatch, useUser, resolveMimeType, useSDKChainId, useContract, ThirdwebProviderCore, useConnect } from '@thirdweb-dev/react-core';
...
import { useTheme, keyframes, ThemeProvider } from '@emotion/react';
...
import { EmbeddedWallet, LocalWallet, walletIds, MetaMaskWallet, SignerWallet, assertWindowEthereum, getInjectedMetamaskProvider, getInjectedCoinbaseProvider } from '@thirdweb-dev/wallets';
import { F as FormFieldWithIconButton, Q as QRCode, s as safeChainIdToSlug, w as wait, b as WalletLogoSpinner, H as HeadlessConnectUI, d as defaultWallets } from './safeChainSlug-ba658c19.browser.esm.js';
...
const DEFAULT_AUTH_OPTIONS = ["email", "google", "apple"
// "facebook",
];

const embeddedWallet = _config => {
  const defaultConfig = {
    auth: {
...
const WalletAddressContainer = styled.button`
  all: unset;
  width: 100%;
  box-sizing: border-box;
  cursor: pointer;
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./safeChainSlug-ba658c19.browser.esm.js').then(function (n) { return n.R; });
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./safeChainSlug-ba658c19.browser.esm.js').then(function (n) { return n.T; });
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./safeChainSlug-ba658c19.browser.esm.js').then(function (n) { return n.h; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./safeChainSlug-ba658c19.browser.esm.js').then(function (n) { return n.g; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-5086d529.browser.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-45747917.browser.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-1be17232.browser.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./safeChainSlug-ba658c19.browser.esm.js').then(function (n) { return n.i; });
    return connect(walletConnect(options), options);
  }, [connect]);
}

export { ConnectWallet as C, ExportLocalWallet as E, MediaRenderer as M, NetworkSelector as N, OTPInput as O, ThirdwebProvider as T, Web3Button as W, ConnectModalInline as a, useRainbowWallet as b, useTrustWallet as c, defaultTokens as d, embeddedWallet as e, useMetamask as f, useCoinbaseWallet as g, useFrameWallet as h, useBloctoWallet as i, useEmbeddedWallet as j, useEmbeddedWalletSendVerificationEmail as k, usePaperWalletUserEmail as l, usePaperWallet as m, useWalletConnect as n, useWalletConnectV1 as o, useResolvedMediaType as p, ThirdwebNftMedia as q, openOauthSignInWindow as r, useInstalledWallets as u };
