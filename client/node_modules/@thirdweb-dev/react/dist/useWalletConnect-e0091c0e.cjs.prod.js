...
var formElements = require('./formElements-4c69f4c3.cjs.prod.js');
var Tooltip = require('./Tooltip-ce856655.cjs.prod.js');
...
var coinbaseWallet = require('./safeChainSlug-48e1c5bd.cjs.prod.js');
...
const EmbeddedWalletSocialLogin = props => {
  const locale = formElements.useTWLocale().wallets.embeddedWallet.socialLoginScreen;
  const {
    goBack,
    modalSize
  } = props;
...
const CheckboxButton = styled__default["default"](formElements.IconButton)`
...
`;
const BounceContainer = styled__default["default"].div`
...
const EmbeddedWalletOTPLoginUI = props => {
  ...
  const [screen, setScreen] = React.useState("base"); // TODO change
    ...
    if (!props.open) {
      if (contentRef.current) {
        const animationConfig = {
          duration: Tooltip.modalCloseFadeOutDuration,
          fill: "forwards",
          easing: "ease"
        };
        ...
        overlayRef.current?.animate([{
          ...
          ...animationConfig,
          duration: Tooltip.modalCloseFadeOutDuration + 100
        });
      } else {
        setOpen(props.open);
      }
      ...
      children: [!props.hide && /*#__PURE__*/jsxRuntime.jsx(Dialog__namespace.Overlay, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(DialogContent, {
          ...
          style: props.hide ? {
            ...
            height: props.size === "compact" ? "auto" : Tooltip.wideModalMaxHeight,
            maxWidth: props.size === "compact" ? Tooltip.modalMaxWidthCompact : Tooltip.modalMaxWidthWide
          },
          children: [props.size === "compact" ? /*#__PURE__*/jsxRuntime.jsxs(DynamicHeight, {
            maxHeight: Tooltip.compactModalMaxHeight,
            children: [props.children, " "]
...
const WalletAddressContainer = styled__default["default"].button`
  all: unset;
  width: 100%;
  box-sizing: border-box;
  cursor: pointer;
...
const ConnectedWalletDetails = props => {
  ...
  const shortAddress = address ? reactCore.shortenString(address) : "";
  ...
  let networkSwitcherButton = /*#__PURE__*/jsxRuntime.jsxs(MenuButton, {
    type: "button",
  ...
  if (!disableSwitchChain) {
    networkSwitcherButton = /*#__PURE__*/jsxRuntime.jsx(Tooltip.ToolTip, {
  ...
  const content = /*#__PURE__*/jsxRuntime.jsxs("div", {
    children: [/*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      ...
      flex: "column",
      gap: "sm",
      children: [personalWallet && personalWalletConfig && !props.hideSwitchToPersonalWallet && /*#__PURE__*/jsxRuntime.jsx(WalletSwitcher, {
...
const ConnectModalContent = props => {
  ...
  const handleConnected = React.useCallback(() => {
    ...
    if (requiresSignIn) {
      setScreen(Tooltip.reservedScreens.signIn);
    }
  ...
  const walletList = /*#__PURE__*/jsxRuntime.jsx(formElements.WalletSelector, {
    ...
    onGetStarted: () => {
      setScreen(Tooltip.reservedScreens.getStarted);
    },
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Tooltip.ScreenContext.Provider, {
    ...
    children: isWideModal ? /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(LeftContainer, {
        ...
        scrollY: true,
        relative: true,
        children: [screen === Tooltip.reservedScreens.signIn && /*#__PURE__*/jsxRuntime.jsx(SignatureScreen, {
          onDone: closeModal,
          modalSize: modalSize,
          termsOfServiceUrl: modalConfig.termsOfServiceUrl,
          privacyPolicyUrl: modalConfig.privacyPolicyUrl
        }), screen === Tooltip.reservedScreens.main && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
          children: getStarted
        }), screen === Tooltip.reservedScreens.getStarted && getStarted, typeof screen !== "string" && getWalletUI(screen)]
      })]
    }) : /*#__PURE__*/jsxRuntime.jsxs(formElements.Container, {
      flex: "column",
      scrollY: true,
      ...
      children: [screen === Tooltip.reservedScreens.signIn && /*#__PURE__*/jsxRuntime.jsx(SignatureScreen, {
        ...
        termsOfServiceUrl: modalConfig.termsOfServiceUrl,
        privacyPolicyUrl: modalConfig.privacyPolicyUrl
      }), screen === Tooltip.reservedScreens.main && walletList, screen === Tooltip.reservedScreens.getStarted && getStarted, typeof screen !== "string" && getWalletUI(screen)]
    })
  });
};
const ConnectModal = () => {
  ...
  React.useEffect(() => {
    if (isWalletModalOpen && screen === Tooltip.reservedScreens.signIn && !wallet) {
      setScreen(initialScreen);
      setIsWalletModalOpen(false);
    }
...
const ConnectModalInline = props => {
  ...
  const walletUIStatesProps = {
    theme: props.theme || Tooltip.defaultTheme,
    modalSize: modalSize,
  ...
  return /*#__PURE__*/jsxRuntime.jsx(formElements.WalletUIStatesProvider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(CustomThemeProvider, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(ConnectModalInlineContainer, {
        className: props.className,
        style: {
          height: modalSize === "compact" ? "auto" : Tooltip.wideModalMaxHeight,
          maxWidth: modalSize === "compact" ? Tooltip.modalMaxWidthCompact : Tooltip.modalMaxWidthWide
        },
...
function useRainbowWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-48e1c5bd.cjs.prod.js'); }).then(function (n) { return n.RainbowWallet; });
...
function useTrustWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      trustWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-48e1c5bd.cjs.prod.js'); }).then(function (n) { return n.TrustWallet; });
...
function useMetamask() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-48e1c5bd.cjs.prod.js'); }).then(function (n) { return n.metamaskWallet$1; });
...
function useCoinbaseWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-48e1c5bd.cjs.prod.js'); }).then(function (n) { return n.coinbaseWallet$1; });
...
function useFrameWallet() {
  ...
  return React.useCallback(async connectOptions => {
    const {
      frameWallet
    } = await Promise.resolve().then(function () { return require('./frameWallet-455a5922.cjs.prod.js'); });
...
function usePaperWallet() {
  ...
  return React.useCallback(async options => {
    const {
      paperWallet
    } = await Promise.resolve().then(function () { return require('./paperWallet-aead880f.cjs.prod.js'); });
...
function useWalletConnectV1() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnectV1
    } = await Promise.resolve().then(function () { return require('./walletConnectV1-9e2d5ae1.cjs.prod.js'); });
...
function useWalletConnect() {
  ...
  return React.useCallback(async options => {
    const {
      walletConnect
    } = await Promise.resolve().then(function () { return require('./safeChainSlug-48e1c5bd.cjs.prod.js'); }).then(function (n) { return n.walletConnect$1; });
