import { cp as RPCConnectionHandler, aM as resolveAddress, cq as signTypedDataInternal, O as getDefaultGasOverrides, aS as ChainId, a_ as getChainProvider, cr as ContractWrapper, aV as NATIVE_TOKEN_ADDRESS, cs as extractFeatures, ac as detectFeatures, aR as getMultichainRegistryAddress, aJ as fetchPublishedContractFromPolygon, aI as THIRDWEB_DEPLOYER$1, aK as fetchAndCacheDeployMetadata, ay as getCreate2FactoryAddress, aG as encodeConstructorParamsForImplementation, aF as computeDeploymentInfo, aw as isContractDeployed, J as fetchContractMetadataFromAddress, ap as fetchSourceFilesFromMetadata, a2 as extractConstructorParamsFromAbi, a5 as resolveContractUriFromAddress, aQ as getContractPublisherAddress, ab as fetchExtendedReleaseMetadata, bj as AbiSchema, as as COMMON_FACTORY, ax as isEIP155Enforced, ct as CUSTOM_GAS_FOR_CHAIN, aH as getCreate2FactoryDeploymentInfo, aO as CONTRACT_ADDRESSES, cu as AddressZero, aD as computeForwarderAddress, P as PackInitializer, b as MarketplaceV3Initializer, M as MarketplaceInitializer, f as SplitInitializer, V as VoteInitializer, g as TokenInitializer, T as TokenDropInitializer, a as EditionInitializer, E as EditionDropInitializer, c as MultiwrapInitializer, e as SignatureDropInitializer, N as NFTCollectionInitializer, d as NFTDropInitializer, h as PREBUILT_CONTRACTS_MAP, k as getContractName, bF as CommonPlatformFeeSchema, bE as CommonPrimarySaleSchema, bG as CommonTrustedForwarderSchema, bB as CommonContractSchema, bD as CommonRoyaltySchema, bH as CommonSymbolSchema, aB as computeDeploymentAddress, aA as getInitBytecodeWithSalt, aT as setSupportedChains, j as getContractTypeForRemoteName, b3 as getSignerAndProvider, al as getCompositeABI, b1 as isChainConfig, aP as getContractAddressByChainId, cv as getProcessEnv, bR as DropErc721ContractSchema, i as PREBUILT_CONTRACTS_APPURI_MAP, aZ as EventType } from './index-1f21bb77.browser.esm.js';
import { ThirdwebStorage } from '@thirdweb-dev/storage';
import { C as ContractPublisher } from './contract-publisher-b459619e.browser.esm.js';
...
import { c as buildTransactionFunction, T as Transaction, f as buildDeployTransactionFunction, D as DeployTransaction } from './transactions-e1717c1c.browser.esm.js';
import { i as isNativeToken, a as fetchCurrencyValue, C as ContractEncoder } from './fetchCurrencyValue-5c32dbf0.browser.esm.js';
import EventEmitter from 'eventemitter3';
import invariant from 'tiny-invariant';
import { n as normalizePriceValue } from './normalizePriceValue-983b07c4.browser.esm.js';
import { defaultChains } from '@thirdweb-dev/chains';
import { GENERATED_ABI } from '@thirdweb-dev/generated-abis';
import { g as getDeploymentInfo, c as createTransactionBatches, a as deployWithThrowawayDeployer, d as deployContractDeterministic } from './deployWithThrowawayDeployer-1d350b63.browser.esm.js';
...
class ThirdwebSDK extends RPCConnectionHandler {
  ...
  async getContractFromAbi(address, abi) {
    const [resolvedAddress, {
      SmartContract
    }] = await Promise.all([resolveAddress(address), import('./smart-contract-1e6b441e.browser.esm.js')]);
    if (this.contractCache.has(resolvedAddress)) {
      return this.contractCache.get(resolvedAddress);
    }
