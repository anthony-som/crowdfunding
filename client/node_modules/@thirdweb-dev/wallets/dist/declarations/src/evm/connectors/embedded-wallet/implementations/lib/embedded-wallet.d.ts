import { type EmbeddedWalletConstructorType, type GetUser } from "../interfaces/embedded-wallets/embedded-wallets";
...
export declare class EmbeddedWalletSdk {
     ...
     */
    constructor({ clientId, chain, styles, onAuthSuccess, }: EmbeddedWalletConstructorType);
    /**
